...
CREATE INDEX idx_activity_order_id ON activity_logs(order_id);
...
CREATE INDEX idx_activity_user_not_null ON activity_logs(user_id, created_at) WHERE user_id IS NOT NULL;
