...
SELECT
    ...
    AVG(EXTRACT(EPOCH FROM (o.actual_delivery_time - o.picked_up_at))/60) as avg_delivery_time_minutes,
...
GROUP BY c.id, DATE(o.created_at), c.avg_rating, c.vehicle_type;
