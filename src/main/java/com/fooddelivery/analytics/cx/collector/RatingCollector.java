...
public class RatingCollector {
    ...
    public AppStoreRatingMetricsDto collectAppStoreRatings(LocalDateTime startDate, LocalDateTime endDate,
        ...
        AppStoreRatingMetricsDto.PlatformRatingDto iosPlatformDto = AppStoreRatingMetricsDto.PlatformRatingDto.builder()
                .platform("IOS")
        ...
        AppStoreRatingMetricsDto.PlatformRatingDto androidPlatformDto = AppStoreRatingMetricsDto.PlatformRatingDto.builder()
                .platform("ANDROID")
        ...
        AppStoreRatingMetricsDto.AppStoreRatingMetricsDtoBuilder builder = AppStoreRatingMetricsDto.builder()
                ...
                .iosRatings(iosPlatformDto)
                .androidRatings(androidPlatformDto)
                .iosPlatform(iosPlatformDto)
                .androidPlatform(androidPlatformDto)
